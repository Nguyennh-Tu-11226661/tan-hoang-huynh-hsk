...
APP_HELP = {
    ...
    "content": "Quản lý bài viết, feedback và thư viện hiển thị ở Góc học tập, Thành tích và Thư viện.",
...
MODEL_HELP = {
    ...
    "Testimonial": "Feedback đang hiển thị sẽ xuất hiện ở Trang chủ và trang Thành tích.",
    ...
    "TrialLessonBooking": "Dữ liệu từ form học thử/test. Đổi trạng thái chỉ phục vụ xác nhận lịch, không hiện ngoài website.",
