...
admissions/   Form tư vấn, học thử/kiểm tra đầu vào, chống spam, xuất CSV/Excel
content/      Blog, cảm nhận học viên, thư viện ảnh/video
...
- Lịch học thử / kiểm tra đầu vào
- Bài viết, cảm nhận học viên, thư viện
